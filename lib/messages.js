...
YammerMessagesAPI.prototype.like = function(id, callback) {      
    this.doPost(this.baseUrl + '/messages/liked_by/current.json', { "message_id": id }, callback);    
};
